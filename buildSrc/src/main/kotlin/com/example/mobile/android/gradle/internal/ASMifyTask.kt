package com.example.mobile.android.gradle.internal
...
abstract class ASMifyTask : Exec() {
    ...
    @get:Input
    var output: com.example.mobile.android.gradle.internal.ASMifyTask.Output =
        com.example.mobile.android.gradle.internal.ASMifyTask.Output.CONSOLE

    @get:OptionValues("output")
    val supportedOutputs: Collection<com.example.mobile.android.gradle.internal.ASMifyTask.Output> = EnumSet.allOf(
        com.example.mobile.android.gradle.internal.ASMifyTask.Output::class.java)
    ...
    override fun exec() {
        val asmJars = project.configurations.getByName("compileClasspath")
            ...
            .filter {
                ...
                return@filter name.startsWith(com.example.mobile.android.gradle.internal.ASMifyTask.Companion.ASM) || name.startsWith(
                    com.example.mobile.android.gradle.internal.ASMifyTask.Companion.ASM_UTIL
                )
            }
        executable = "java"
        args(
            ...
            com.example.mobile.android.gradle.internal.ASMifyTask.Companion.ASMIFIER_CLASS,
            "-nodebug",
            clazz
        )

        if (output == com.example.mobile.android.gradle.internal.ASMifyTask.Output.FILE) {
            val dir = File(tmpDir)
            dir.mkdirs()
