package com.sandymist.mobile.android.gradle.internal
...
abstract class ASMifyTask : Exec() {
    ...
    @get:Input
    var output: com.sandymist.mobile.android.gradle.internal.ASMifyTask.Output =
        com.sandymist.mobile.android.gradle.internal.ASMifyTask.Output.CONSOLE

    @get:OptionValues("output")
    val supportedOutputs: Collection<com.sandymist.mobile.android.gradle.internal.ASMifyTask.Output> = EnumSet.allOf(
        com.sandymist.mobile.android.gradle.internal.ASMifyTask.Output::class.java)
    ...
    override fun exec() {
        val asmJars = project.configurations.getByName("compileClasspath")
            ...
            .filter {
                ...
                return@filter name.startsWith(com.sandymist.mobile.android.gradle.internal.ASMifyTask.Companion.ASM) || name.startsWith(
                    com.sandymist.mobile.android.gradle.internal.ASMifyTask.Companion.ASM_UTIL
                )
            }
        executable = "java"
        args(
            ...
            com.sandymist.mobile.android.gradle.internal.ASMifyTask.Companion.ASMIFIER_CLASS,
            "-nodebug",
            clazz
        )

        if (output == com.sandymist.mobile.android.gradle.internal.ASMifyTask.Output.FILE) {
            val dir = File(tmpDir)
            dir.mkdirs()
